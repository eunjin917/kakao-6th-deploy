...
===== 요청 예시
include::{snippets}/{product}/find-all_not-found_test/http-request.adoc[]

===== 응답 예시
include::{snippets}/{product}/find-all_not-found_test/response-body.adoc[]
...
===== 요청 예시
include::{snippets}/{cart}/find-all_is-empty_test/http-request.adoc[]

===== 응답 예시
include::{snippets}/{cart}/find-all_is-empty_test/response-body.adoc[]
